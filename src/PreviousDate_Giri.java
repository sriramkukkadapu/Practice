...
public class PreviousDate_Giri 

{
	int index=0;
 public static void main(String[] arg)
 {
	 PreviousDate_Giri d=new PreviousDate_Giri();
	 
	//int year=2020, date=1; String month="january";
	 Scanner in = new Scanner(System.in);
	 System.out.print("Enter Month: ");String month= in.nextLine();
 ...
 public void data(String month, int year, int date, int extraDay)
 {
	 ...
	 if(map.containsKey(month.toLowerCase()))
	 {
		 ...
		 else if(month.equals("january")&&date==1)
		 {
			 ...
			 System.out.println(map.get(months.get(months.size()-1)));
